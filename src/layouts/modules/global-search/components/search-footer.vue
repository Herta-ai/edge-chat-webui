...
<template>
  <div class="h-44px flex-y-center gap-14px px-24px">
    <span class="flex-y-center">
      <i-mdi-keyboard-return class="operate-shadow operate-item" />
      <span>{{ $t('common.confirm') }}</span>
    </span>
    <span class="flex-y-center">
      <i-mdi-arrow-up-thin class="operate-shadow operate-item" />
      <i-mdi-arrow-down-thin class="operate-shadow operate-item" />

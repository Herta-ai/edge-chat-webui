...
import { cleanup, genChangelog, generateRoute, gitCommit, gitCommitVerify, release } from './commands'
import { loadCliOptions } from './config'
import type { Lang } from './locales'

type Command = 'cleanup' | 'git-commit' | 'git-commit-verify' | 'changelog' | 'release' | 'gen-route'
